...
<body>
		...
		<div class="wrapper_top_w3layouts">
			<div class="header_agileits">
				<div class="logo inner_page_log">
				  <h1><a class="navbar-brand" href="index.html"><span>Angle</span> <em>Tech</em></a></h1>
				</div>
	...
	List<Check> checkList=(List<Check>)request.getAttribute("checkList");
	%>
    	<%if(checkList.isEmpty()) out.print("<h2 align='center'>EMPTY! YOU'VE NEVER BOUGHT ANYTHING BEFORE!</h2><br>");
    	for(int i=0;i<checkList.size();i++){
    		out.print("<tr class='rem1'><td class='1'>");
    		out.print(checkList.get(i).getOrderID());
    		out.print("</td><td class='invert-image'>");
    		Iterator<Commodity> iterator=cartList.get(i).cartHashMap.keySet().iterator();
    		while(iterator.hasNext()){
    			Commodity c=iterator.next();
    			out.print("<a href='ViewProductDetails?productName="+c.getName()+"' style='display: inline-block'><img src='images/"+c.getName()+".jpg' alt='' class='img-responsive' style='width:100px' ><span>"
						+c.getName()+" : "+Integer.toString(cartList.get(i).cartHashMap.get(c))+
						"</span></a>");
    		}
    		out.print("</td><td class='subTotal'>"
					+Float.toString(checkList.get(i).getTotalPrice())
					+"</td><td class='operation'><span class='delete'>"
					+checkList.get(i).getDateString()+
					"</span></td></tr>");
		...
		<div class="footer_agileinfo_w3">
			<div class="footer_inner_info_w3ls_agileits">
				<div class="col-md-3 footer-left">
					...
					<p>Hope our product can give you a new angle to view the world。</p>
